...
const socialLinks: socialLinks[] = [
    {
        ...
        link: 'https://facebook.com/pixelayout',
        width: 10
    },
    {
        imgSrc: '/images/Footer/insta.svg',
        link: 'https://instagram.com/pixelayout',
        width: 14
    },
    {
        imgSrc: '/images/Footer/twitter.svg',
        link: 'https://twitter.com/pixelayout',
        width: 14
    },
        ...
        <div className="mx-auto max-w-2xl pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    ...
                    <h3 className='text-textbl text-xs font-medium mt-5 mb-4 lg:mb-16'> Let our chef cook anything for you without a fuss <br /> The best is waiting for you.</h3>
            ...
            <div className='py-10 md:flex items-center justify-between border-t border-t-bordertop'>
                <h4 className='text-darkgrey text-sm text-center md:text-start font-normal'>@2023 - Pixel Layout. All Rights Reserved by <Link href="https://pixelayout.site/" target="_blank"> Pixel Layout</Link></h4>
