...
const cardData: cardDataType[] = [
    {
        ...
        subheading: "Explore diverse menu options for culinary delights.",
        link: 'Learn more'
    },
    {
        imgSrc: '/images/Features/featureTwo.svg',
        heading: "Meat Lover's Paradise",
        subheading: "Indulge in the finest minced meat delicacies that will leave you craving for more.",
        link: 'Learn more'
    },
    {
        imgSrc: '/images/Features/featureThree.svg',
        heading: "Grilled Chicken",
        subheading: "Delight in succulent grilled chicken prepared to perfection.",
        link: 'Learn more'
    },
    {
        imgSrc: '/images/Features/featureFour.svg',
        heading: "Fast food",
        subheading: "Savor quick and delicious fast-food creations.",
        link: 'Learn more'
    }
                        ...
                        {cardData.map((items, i) => (
                            <div className='card-b p-8 relative rounded-3xl' key={i}>
                                <div className='work-img-bg rounded-full flex justify-center absolute top-[-50%] sm:top-[-40%] md:top-[-55%] lg:top-[-45%] left-[0%]'>
                                    <img src={items.imgSrc} alt={items.imgSrc} width={510} height={10} />
                                </div>
