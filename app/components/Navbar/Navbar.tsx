                    ...
                    <div className="relative flex h-8 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <div className="flex sm:hidden flex-shrink-0 items-center border-right">
                                <img src="/images/Logo/logo.png" alt="logo" width={36} height={36} />
                            ...
                            <div className='gap-6 hidden lg:flex'>
                                <div className='flex items-center gap-2'>
                                    <img src={'/images/Navbar/phone.svg'} alt="phone-image" width={19} height={19} />
                                    <p className='text-lg font-medium'>+(254) 740-455-200</p>
                                </div>
